...
class Figure:
    ...
    def add_line_of_best_fit(self, x_data, y_data, order=1, density = 100, display_equation = False, display_equation_position = None, **kwargs):
        ...
        if ((display_equation == True) & (display_equation_position is not None)):
            self.ax.text(display_equation_position[0], display_equation_position[1], equation_text)
